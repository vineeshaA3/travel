    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="index.php">Home </a> <span class="lnr lnr-arrow-right"></span> <a href="currency.php"> Forex</a></p>
            </div>
        </div>
    </div>
</section><br><br>
...
<div class="container-fluid">
    <div class="row">
        <h2 class="banner">Currency Conveter</h2>
        <div class="colum">
        ...
        <!--End colum-->
        <button class="btn" type="button">CALCULATE</button><br>
        <h3 class="amount" text-align="center">
